...
<div class="width1220">
  <div class="left_col">
	<div class="contact_box">
	  ...
	  <div class="input_box">
		<input type="text" id="textfield2" placeholder="Your Name" name="name"/>
	  </div>
	  <div class="input_box">
		<input type="text" id="textfield2" placeholder="Your Email" name="email" />
	  </div>
	  <div class="input_box">
		<input type="text" id="textfield2" placeholder="Your Website" name="website"/>
	  </div>
	  <div class="input_box2">
		<textarea id="textarea" placeholder="Your Message" cols="45" rows="5" style="min-height:200px;" name="message"></textarea>
	  </div>
	  <div class="input_box">
