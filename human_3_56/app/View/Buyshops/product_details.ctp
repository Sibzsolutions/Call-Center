				   ...
				   <div class="box_1-cart">
					 <div class="box_11"><a href="<?php echo $this->webroot.'buyshops/checkout';?>">
					  ...
					  if(isset($count_add_to_cart) && isset($count_add_cart_session))
						echo $count_last = ($count_add_to_cart+$count_add_cart_session); 			  
					  elseif(isset($count_add_cart_session))
						echo $count_last = $count_add_cart_session; 
					  elseif(isset($count_add_to_cart))
						echo $count_last = $count_add_to_cart; 
					  else
						echo "0" ; 							
			         ...
			         <div class="simpleCart_shelfItem">
			         	<div class="price_single">
						  ...
						  if(isset($count_last))
						  {
							  ...
							  {
								  ?>
								  <div class="size_2-right"><button id="added_to_cart">Added to Cart</button></div>
								  <?php
							  }
							  else
							  {
								  ?>
								  <div class="size_2-right"><button id="add_to_cart">Add To Cart</button></div>
								  <?php
							  }
						  }
						  else
						  ...
						  <div class="size_2-right added_cart"><button id="added_to_cart">Added to Cart</button></div>
