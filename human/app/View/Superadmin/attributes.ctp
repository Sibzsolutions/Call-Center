...
<div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <a class="login_button" href="<?php echo $this->webroot.'superadmin/add_attribute'; ?>">Add Attribute</a>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr>
                        ...
                        <th bgcolor="#00bcd4" class="text14_white">Parent Category</th>
                        <th bgcolor="#00bcd4" class="text14_white">Attribute Description</th>
