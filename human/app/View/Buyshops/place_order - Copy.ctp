    ...
    JQUERY4U.UTIL =
    {
		...
		"Please specify a valid phone number");
            ...
            $("#address_form_submit").validate({
                ...
                messages: {
                    addr1: {
                        required: "Please provide a first address",
                        minlength: "Your addr1 must be at least 5 characters long",
						accept: "Please enter the letters only"
                    },
					...
					usrzip: {
                        ...
                        minlength: "Your addr1 must be at least 5 characters long",
						zipcodeUS: "Please enter the correct format of zip codes"
                    },
					usrphones: {
                        required: "Please provide a zip code",
                        phoneUS: "Please enter the correct format of aaaaaaaaazip codes"
                    },
		...
		$('#submit_addr_data').click(function(){
			...
			$("#address_form_submit").validate({ 
				...
				messages: {
                    addr1: "Please enter your firstname",
				},
...
<form id="address_form_submit">

<div class="register-top-grid" style="clear:both">

	<!--<input type="text" name="usrcity">	
	...
	<input type="text" name="usrstate">
	
	<input type="text" name="usrcountry">
	
	<input type="text" name="usrzip">-->

<div>
	<span>First Address<label>*</label></span>
	<?=$this->Form->input('addr1',array('type'=>'textarea', 'name'=>'addr1', 'style'=>'width:500px', 'class'=>'addr1 form-control','label'=>'','div'=>false,'Placeholder'=>'Enter the First Address'));?>
 ...
 <div>
	...
	<?=$this->Form->input('addr2',array('type'=>'textarea',  'name'=>'addr2','style'=>'width:500px', 'class'=>'addr2 form-control','required'=>'required','label'=>'','div'=>false,'Placeholder'=>'Enter the First Address'));?>
 ...
 <div>
	...
	<?=$this->Form->input('usrcity',array('type'=>'text',  'name'=>'usrcity','class'=>'usrcity form-control','required'=>'required','label'=>'','div'=>false,'Placeholder'=>'Enter the City'));?>
 ...
 <div>
	...
	<?=$this->Form->input('usrstate',array('type'=>'text',  'name'=>'usrstate', 'class'=>'usrstate form-control','required'=>'required','label'=>'','div'=>false,'Placeholder'=>'Enter the State'));?>
 ...
 <div>
 	...
 	<?=$this->Form->input('usrcountry',array('type'=>'text',  'name'=>'usrcountry', 'class'=>'usrcountry form-control','required'=>'required','label'=>'','div'=>false,'Placeholder'=>'Enter the Country'));?>
 ...
 <div>
	 ...
	 <?=$this->Form->input('usrphones',array('type'=>'text', 'style'=>'width:560px','class'=>'usrphones form-control','required'=>'required','label'=>'','div'=>false,'Placeholder'=>'Enter the Phone Number'));?>
