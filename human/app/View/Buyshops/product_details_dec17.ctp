										...
										<script>
											...
											if($(this).is(":checked"))
											{
													...
													if(result == "not_logged")
													{
														...
														$("#discounted_price_msg").html("Please Logged in first..!!<br><br><a href='<?php echo $this->webroot.'buyshops/login'; ?>'>Click here to login</a>");								    													
														$('#place_order').hide();														
														$('#coupon_btn').hide();																												
													}
			         ...
			         <div class="simpleCart_shelfItem">
						 ...
						 <?php
							...
							else
							{
								...
								<button id="add_to_cart"  class="add crt add_cart_btm">Add To Cart2</button>
								<!--<div id="one_msg" class="error_mess">Please insert the all attributes</div>-->
						...
						<div id="discounted_price_msg"  class="apply_btn" style="padding: 0px"></div>
						<!--<button id="discounted_price_msg"  class="apply_btn" style="padding: 0px"></button>-->
						<br />
                        <button class="add_cart_btm" id="place_order" style="clear: both; float: left; font-size: 14px; text-transform: uppercase;">Buy</button>
