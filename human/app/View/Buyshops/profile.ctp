...
<div class="width1220 address_edit_box">
	...
	<div class="register-top-grid">
					...
					<div>
						<span>Password</span>
						<?=$this->Form->input('password_new',array('type'=>'password','id'=>'password_new', 'class'=>'form-control','label'=>'','div'=>false,'Placeholder'=>'Enter the new password'));?>
						<div class="pass_new"></div>
					</div>
...
$(document).ready(function(c) {
		...
		$("#other").click(function() {
			...
			var pass_newa = $('#password_new').val();
			...
			{
				var a = (pass_newa.length);
				
				if((a<=5))
				{
					$(".pass_new").html("Please enter the length between 5 to 40 characters");
					return false;
				}
				else				
				{
