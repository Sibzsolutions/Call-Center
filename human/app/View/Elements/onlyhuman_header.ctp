<?php
	...
	App::import('Controller', 'Onlyhumans');
	$Onlyhuman = new OnlyhumanController;
?>

<div class="header">
    <div class="width1220" style="min-height:127px;">
      <div class="logo"><a href="<?php echo $this->webroot.'onlyhuman/'; ?>"><img src="<?php echo $this->webroot.'img/only_human_userside/logo.jpg'; ?>" /></a></div>
      ...
      <div class="top_right">
        ...
        <div class="online_store">
          ...
          <div id="cart" class="cart_box">
		   <a href="<?php echo $this->webroot.'onlyhuman/checkout';?>">
        ...
        <div class="top_menu">
		  ...
		  <a href="#">Blog</a>
		  <a href="<?php echo $this->webroot.'onlyhuman/checkout'; ?>">Checkout</a>
		  <a href="#">English</a>
		  <a href="#">USD</a>
		  <a href="<?php echo $this->webroot.'onlyhuman/contact_us'; ?>">Contact Us</a>		  
			<?php
					
				if(AuthComponent::user()):
				?>
				<a href="<?php echo $this->webroot.'onlyhuman/myaccount'; ?>">My Account</a>
				<a href="#">My Wishlist</a>
				<a href="<?php echo $this->webroot.'onlyhuman/logout'; ?>">Logout</a>
				<?php
				else:
				?>
				<a href="<?php echo $this->webroot.'onlyhuman/login'; ?>">Login</a>
				<?php 
				endif;					
			?>          
        </div>
    ...
    <div class="main_menu">
      <div class="width1220">
        ...
        <div class="search">
			...
			<form method="post" action="<?php echo $this->webroot.'onlyhuman/search_results'; ?>">
         ...
         <div class="cssmenu">
			<ul>
				<?php
					...
					if(AuthComponent::user()):
					?>
					<li class="active"><a href="<?php echo $this->webroot.'onlyhuman/index'; ?>">My Account</a></li> 
					<li class="active"><a href="<?php echo $this->webroot.'onlyhuman/logout'; ?>">Logout</a></li> 
					<?php
					else:
					?>
					<li class="active"><a href="<?php echo $this->webroot.'onlyhuman/login'; ?>">Login</a></li> 
					<?php 
					endif;
