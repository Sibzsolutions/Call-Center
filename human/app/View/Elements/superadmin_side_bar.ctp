...
<ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/site_setting'?>">
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/users'?>">
            <i class="fa fa-pie-chart"></i>
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/dynamic_pages'?>">
            <i class="fa fa-pie-chart"></i>
            <span>CMS</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>              
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/categories'?>">
            <i class="fa fa-pie-chart"></i>
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/products'; ?>">
            <i class="fa fa-pie-chart"></i>
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/attributes'; ?>">
            <i class="fa fa-pie-chart"></i>
        ...
        <li class="treeview">
          <a href="<?php echo $this->webroot.'Superadmin/offers'; ?>">
            <i class="fa fa-pie-chart"></i>
