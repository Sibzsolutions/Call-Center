					...
					$(document).ready(function(){
						...
						$( "#checkbox_<?php echo $att_element['id'].'_'.$att_element['attid']; ?>" ).click(function() {
							...
							if($(this).is(":checked"))
							{
								...
								$.post("<?php echo $this->webroot; ?>Onlyhuman/filter_search_type/",
								{type:type,checked:1},
	    ...
	    <div class="women">
			...
			$(document).ready(function(){
				...
				$('.alphabeticle_list_products').click(function(){
					...
					$.post("<?php echo $this->webroot?>onlyhuman/sort_products", {type_id:id}, function(result){
			...
			foreach($products as $product)
			{
				...
				$(document).ready(function(){
					...
					$('#item_add_add3_<?php echo $product['id']; ?>').click(function(){
						...
						$.post("<?=$this->webroot?>onlyhuman/add_to_cart", {product_id: $('#product_id_<?php echo $product['id']; ?>').val()}, function(result){
