...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo $this->webroot.'js/temop_first/app.min.js';?>"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo $this->webroot.'js/temop_first/demo.js';?>"></script>
    <!-- FLOT CHARTS -->
    ...
    <script src="<?php echo $this->webroot.'plugins/flot/jquery.flot.pie.min.js';?>"></script>
    <!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
    <script src="<?php echo $this->webroot.'plugins/flot/jquery.flot.categories.min.js';?>"></script>
    <!-- Page script -->
    <script>
      $(function () {
