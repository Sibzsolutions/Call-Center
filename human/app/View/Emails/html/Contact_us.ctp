...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:2px solid #ececec">
  ...
  <tr>
	  <tr>
        <td align="center" valign="top">&nbsp;<?php echo "<br><h4>Contact Us</h4>"; ?></td>
      </tr>
	  <tr>
        <td align="left" valign="top">&nbsp;<?php echo "<br>Name:- ".$contact_us_data['Contact_us']['name']; ?></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;<?php echo "<br>Email:- ".$contact_us_data['Contact_us']['email']; ?></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;<?php echo "<br>Website:- ".$contact_us_data['Contact_us']['website']; ?></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;<?php echo "<br>Message:- ".$contact_us_data['Contact_us']['message']; ?></td>
      </tr>
	  <tr>
		<td align="left" valign="top">&nbsp;</td>
      </tr>
