 ...
 class OnlyhumanController extends AppController {
	...
	*/
	...
	function beforeFilter()
	{
		 ...
		 $this->Auth->loginAction=array('controller' => 'Onlyhuman','action' => 'login');
		 $this->Auth->logoutRedirect=array('controller' => 'Onlyhuman','action' => 'login');
		 $this->Auth->loginRedirect = array('controller'=>'Onlyhuman','action'=>'index');
		 ...
		 foreach($cat_data as $key=>$cat)
		 {
			 ...
			 $cat['Category']['url'] = $this->webroot.'onlyhuman/products/'.$cat['Category']['id'];
	 ...
	 Public function category_tree($catid){
		...
		{
			$data['Category']['url'] = $this->webroot.'onlyhuman/products/'.$data['Category']['id'];
