	...
	function beforeFilter()
	{
	 ...
	 Public function filter_search_type()
	 {
		...
		*/
		...
		if(!empty($one))
		{
			//echo "shashikant is in the if part";
			...
			/*
			echo "Conditions_att_or<pre>";
			print_r($conditions_att_or);
			echo "<pre>";
			*/
			...
			if(isset($one_last))
			{
				...
				*/
				...
				if(isset($conditions_att_or))
				{
					...
					/*
					$this->paginate = array('limit' => 2,'conditions'=>array('Produc_master.catid'=>$id_first));			
					
					$products_cat = $this->paginate('Produc_master');
					*/
				}				
				else
				{
				...
				*/
				...
				/*
				echo "Data_one_last<pre>";
				print_r($data_one_last);
				echo "<pre>";
