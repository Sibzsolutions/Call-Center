 ...
 */
 ...
 class BuyshopsController extends AppController {
	...
	*/
	...
	{
		echo "<br>shashikant is in the success payment page";
			...
			*/
			...
			{	
				...
				foreach($attvid_data as $attvid)
				{
					...
					{
						echo "Additonal_cost".$cost_change = $prod_att_data['Produc_attribute']['add_cost'];
						$product_data['Produc_master']['discounted_price'] = ($product_data['Produc_master']['discounted_price'] + $cost_change);
					}
					else
					{
						echo "Less_cost".$cost_change = $prod_att_data['Produc_attribute']['less_cost'];
						$product_data['Produc_master']['discounted_price'] = ($product_data['Produc_master']['discounted_price'] - $cost_change);
					}
	...
	public function payment_page() 
	{
		...
		if($this->Session->check('place_order_data') == 1)
		{
			...
			echo "<br>Shashikant is in the if part<br>";
		...
		{
			echo "shashikant is in the else part";
			die();
		}
	}
	...
	public function price_changed() 
	{
		...
		*/
		...
		if($_REQUEST['checked'] == 1)
		{
			//echo "<br>Shashikant is in the check functionality<br>";
		...
		{
			//echo "<br>Shashikant is in the uncheck functionality<br>";
