 ...
 */
 ...
 class BuyshopsController extends AppController {
	...
	*/
	...
	{
		$category = $this->Category->find('list', array('conditions'=>array('Category.del_status'=>0, 'Category.parentid'=>$id)));
	...
	public function buy_product($id=null, $quantity_data=null, $original_price=null, $original_discounted_price=null, $coupon_discounted_price=null) 
	{
	...
	public function paypal_pro() 
	{
		...
		*/
		...
		{
			echo "Payment not done successfully";
	...
	public function payment_page() 
	{
		...
		if($this->Session->check('place_order_data') == 1)
		{
			...
			$this->Session->write('product_data_new', $product_data);
	...
	public function place_order($original_price=null, $discounted_price=null) 
	{
		...
		{
			//echo "shashikant chobhe is in the else part";
	...
	public function price_changed() 
	{
		if($_REQUEST['checkid'] == 1)
		{
			...
			$product_att_data = $this->Produc_attribute->find('first', array('conditions'=>array('Produc_attribute.prodid' => $_REQUEST['prodid'], 'Produc_attribute.attvid' => $_REQUEST['attvid'])));
		...
		*/
		...
		foreach($products_checkout as $key=>$products)
		{
			...
			if(!empty($products['att']['Color']['id']))
			{
				...
				/*
				echo $products['discounted_price'];
				...
				*/
				...
				echo "<br>Price_change".$price_change;
				*/	
