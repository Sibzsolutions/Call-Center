	...
	*/
	...
	public function product_edit($id) 
	{
		...
		*/
		...
		/*
		echo "shashikant is in the eproduct detail page";
						...
						if(isset($data_second['product_quantity']))
						{
							if($data_second['product_quantity'] != '')
							{
								...
								if($data_count>0)
								{
									...
									{
										$product_data = $this->Produc_master->find('first', array('conditions'=>array('Produc_master.id'=>$last_inserted_id)));
										...
										$notify_data = $this->Notify_prod_email->find('first', array('conditions'=>array('Notify_prod_email.prodid'=>$last_inserted_id, 'Notify_prod_email.attvid'=>$attvid)));
