...
if(!empty($discounted_price))
 ...
 Amount:- <input type="text" id="amount" name="example_payment_amuont" value="<?php echo $amount_price; ?>"/>
...
<!-- Amount:- <input type="text" id="amount" name="example_payment_amuont" value="1"  /> -->							
 ...
 Credit Card Number:- <input type="text" name="customer_credit_card_number" value=""  required="required" id="credit_card_number"/>
 ...
 CVV:- <input type="text" name="cc_cvv2_number" value=""  required="required" id="cvv"/>
 <div class="msg_cvv" id="msg_new_addr"></div>	
	...
	Comment <textarea style="width:400px;height:100px" id="user_comment" name="user_comment">Please Enter the comment here..</textarea>
...
<div class="register-top-grid">
 ...
 <div>
	 <button id="submit_addr_data">submit</button>
 </div>
