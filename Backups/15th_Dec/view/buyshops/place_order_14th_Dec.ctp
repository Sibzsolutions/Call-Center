...
<div class="payment_option_inner input_box">	
 ...
 <input type="text" name="customer_credit_card_number" value=""  required="required" id="credit_card_number"/>
 ...
 <div class="payment_option_inner input_box">
 <span> CVV:- </span>
 <input type="text" name="cc_cvv2_number" value=""  required="required" id="cvv"/>
