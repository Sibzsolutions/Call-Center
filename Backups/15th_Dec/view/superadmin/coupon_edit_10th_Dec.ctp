...
<script type="text/javascript" src="<?php echo $this->webroot.'js/buy_shop/jquery-1.11.1.min.js';?>"></script>
  <?=$this->Form->create('Coupon', array("role"=>"form"));?>
  <div class="box-body form_box">
    <div class="form-group">
      <label for="exampleInputEmail1">User Id</label>
      <?=$this->Form->input('id',array('type'=>'text','class'=>'form-control','required'=>'required','label'=>'','div'=>false,  'placeholder'=>'Enter Id', 'value'=>$coupon_data['id']));?>
    </div>
    <div class="form-group">
